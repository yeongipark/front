...
import { checkAuthCode, sendAuthCode, getCompanyEmail } from '../apis/registerApis.js';
            ...
            .then((response) => {
                if (response.statusCode === 200) {
                    const data = {
                        ...
                        birth: `${date.year}-${String(date.month).padStart(2, '0')}-${String(date.day).padStart(
                            2,
                            '0'
                        )}`,
                    };
        ...
        case 0:
            content = (
                <StepCompanySelection
                    ...
                    companys={companys}
                    getCompanyEmail={(companyName) => getCompanyEmail(companyName, setCompanyEmail, setSelectedCompany)}
